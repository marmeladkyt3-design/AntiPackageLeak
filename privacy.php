...
<meta name="description" content="<?php echo $site_name; ?> — Политика конфиденциальности">
<meta name="theme-color" content="#08080f">
<title>Конфиденциальность — <?php echo $site_name; ?></title>
...
.hero{min-height:auto;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:24px 24px 24px;perspective:800px}
...
<header class="header nav" id="nav">
    <div class="header-content">
        ...
        <nav class="header-nav">
            ...
            <a href="/privacy" class="active">Соглашение</a>
...
<section class="hero" id="hero">
    <div class="hero__badge" id="heroBadge"><i class="fas fa-shield-halved"></i> Политика конфиденциальности</div>
    <h1 id="heroHeading">Конфиденциальность и <span class="grad">защита данных</span></h1>
    <p class="hero__sub">Как мы собираем, используем и защищаем вашу информацию</p>
</section>

<section class="privacy"><div class="container">

    <div class="section" data-stagger="0">
        <div class="section__head">
            <div class="section__icon"><i class="fas fa-database"></i></div>
            <div class="section__meta">
                <div class="section__num">01</div>
                <h2 class="section__title">Сбор и использование данных</h2>
            </div>
        </div>
        <div class="section__body">
            <p class="section__text">Мы собираем исключительно данные, необходимые для функционирования сервиса. Ваша информация не передаётся третьим лицам без вашего согласия.</p>
            <ul class="section__list">
                <li><span class="section__list-icon"><i class="fas fa-user"></i></span><span class="section__list-text">Логин, электронная почта и пароль — используются для авторизации</span></li>
                <li><span class="section__list-icon"><i class="fas fa-fingerprint"></i></span><span class="section__list-text">Идентификатор оборудования (HWID) — привязка подписки к устройству</span></li>
                <li><span class="section__list-icon"><i class="fas fa-clock"></i></span><span class="section__list-text">Время последней активности — для отслеживания статуса подписки</span></li>
                <li><span class="section__list-icon"><i class="fas fa-cog"></i></span><span class="section__list-text">Версия сборки — для корректной работы автообновления</span></li>
            </ul>
        </div>
    </div>
    ...
    <div class="section" data-stagger="1">
        <div class="section__head">
            <div class="section__icon"><i class="fas fa-lock"></i></div>
            <div class="section__meta">
                <div class="section__num">02</div>
                <h2 class="section__title">Хранение и защита</h2>
            </div>
        </div>
        <div class="section__body">
            <p class="section__text">Все данные хранятся на защищённых серверах с шифрованием AES-256. Мы применяем многоуровневую систему безопасности.</p>
            <ul class="section__list">
                <li><span class="section__list-icon"><i class="fas fa-server"></i></span><span class="section__list-text">Серверы расположены в защищённых дата-центрах</span></li>
                <li><span class="section__list-icon"><i class="fas fa-key"></i></span><span class="section__list-text">Все пароли хешируются алгоритмом bcrypt</span></li>
                <li><span class="section__list-icon"><i class="fas fa-shield-halved"></i></span><span class="section__list-text">Данные шифруются при передаче (TLS 1.3)</span></li>
                <li><span class="section__list-icon"><i class="fas fa-database"></i></span><span class="section__list-text">Регулярное резервное копирование</span></li>
            </ul>
        </div>
    </div>
    ...
    <div class="section" data-stagger="2">
        <div class="section__head">
            <div class="section__icon"><i class="fas fa-share-nodes"></i></div>
            <div class="section__meta">
                <div class="section__num">03</div>
                <h2 class="section__title">Передача данных</h2>
            </div>
        </div>
        <div class="section__body">
            <p class="section__text">Мы не продаём и не передаём ваши данные третьим лицам. Единственное исключение — предоставление данных по запросу государственных органов при наличии законных оснований.</p>
            <ul class="section__list">
                <li><span class="section__list-icon"><i class="fas fa-building"></i></span><span class="section__list-text">Платёжные данные обрабатываются платёжными системами</span></li>
                <li><span class="section__list-icon"><i class="fas fa-gavel"></i></span><span class="section__list-text">Данные могут быть предоставлены по законному запросу</span></li>
                <li><span class="section__list-icon"><i class="fas fa-user-shield"></i></span><span class="section__list-text">Нет передачи данных рекламным или аналитическим компаниям</span></li>
            </ul>
        </div>
    </div>
    ...
    <div class="section" data-stagger="3">
        <div class="section__head">
            <div class="section__icon"><i class="fas fa-cookie-bite"></i></div>
            <div class="section__meta">
                <div class="section__num">04</div>
                <h2 class="section__title">Файлы cookie</h2>
            </div>
        </div>
        <div class="section__body">
            <p class="section__text">Сервис использует cookie-файлы исключительно для обеспечения функционирования авторизации и сессий.</p>
            <ul class="section__list">
                <li><span class="section__list-icon"><i class="fas fa-plug"></i></span><span class="section__list-text">Сессионные cookie для поддержания авторизации</span></li>
                <li><span class="section__list-icon"><i class="fas fa-palette"></i></span><span class="section__list-text">Настройки темы и языка интерфейса</span></li>
                <li><span class="section__list-icon"><i class="fas fa-chart-line"></i></span><span class="section__list-text">Нет сторонних трекеров или рекламных cookie</span></li>
            </ul>
        </div>
    </div>
    ...
    <div class="section" data-stagger="4">
        <div class="section__head">
            <div class="section__icon"><i class="fas fa-pen-to-square"></i></div>
            <div class="section__meta">
                <div class="section__num">05</div>
                <h2 class="section__title">Изменения в политике</h2>
            </div>
        </div>
        <div class="section__body">
            <p class="section__text">Мы оставляем за собой право изменять политику конфиденциальности. Об ознакомлении с обновлениями вы уведомляется через официальные каналы связи.</p>
        </div>
    </div>

    <div class="highlight" id="highlight">
        <i class="fas fa-circle-check"></i>
        <p>Ваши данные в безопасности. Мы придерживаемся принципов минимального сбора информации.</p>
    </div>

    <div class="notice" id="notice">
        <i class="fas fa-headset"></i>
        <p>По всем вопросам обращайтесь в поддержку — мы ответим в течение 24 часов.</p>
    </div>
