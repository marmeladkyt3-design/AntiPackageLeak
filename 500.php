...
<title>500 — Ошибка сервера | <?php echo $site_name; ?></title>
<style>
...
<main class="error-page">
    ...
    <p>Что-то пошло не так на нашей стороне.<br>Мы уже знаем об этом — попробуйте обновить страницу через минуту.</p>
    <div class="error-btns">
        <a href="/main" class="error-btn primary"><i class="fas fa-home"></i> На главную</a>
        <a href="javascript:location.reload()" class="error-btn outline"><i class="fas fa-sync"></i> Попробовать снова</a>
    </div>
</main>
